package com.example.ads.appOpen.application
...
class AppOpenAdManager(
        ...
        AppOpenAd.load(
            ...
            object : AppOpenAd.AppOpenAdLoadCallback() {
                ...
                override fun onAdFailedToLoad(loadAppOpenError: LoadAdError) {
                    Log.e(
                        TAG_ADS,
                        "AppOpen -> loadAppOpen: onAdFailedToLoad: ",
                        Exception(loadAppOpenError.message)
                    )
                    isLoadingAd = false
                }
            })
    ...
    fun showAppOpen() {
        ...
        if (currentActivity is AdActivity || isPangleAdActivity(currentActivity) || isMintegralAdActivity(
                currentActivity
            )
        ) {
        ...
        appOpenAd?.fullScreenContentCallback = object : FullScreenContentCallback() {
            ...
            override fun onAdFailedToShowFullScreenContent(adError: AdError) {
                Log.e(
                    TAG_ADS,
                    "AppOpen -> showAppOpen: onAdFailedToShowFullScreenContent: ",
    ...
    private fun wasAdExpired(): Boolean {
        ...
        if (isExpired) {
            Log.e(
                TAG_ADS,
                "AppOpen -> isAdAvailable: wasAdExpired: ",
                IllegalStateException("Ad is expired!")
            )
            appOpenAd = null
        }
        return isExpired
