package com.example.ads.utilities.firebase

import android.util.Log
import com.example.ads.utilities.Constants.TAG
import com.example.ads.utilities.Constants.TAG_REMOTE
    ...
    private fun updateRemoteValues() {
        ...
        sharedPreferenceUtils.apply {
            try {
                ...
                rcInterHome = remoteConfig[interHome].asLong().toInt()
                ...
                Log.i(TAG_REMOTE, "RemoteConfiguration: rcInterOnBoarding -> ${remoteConfig[interHome].asLong().toInt()}")
