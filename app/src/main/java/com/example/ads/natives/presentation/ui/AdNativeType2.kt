...
import com.example.myapplication.databinding.LayoutNativeType2Binding
import com.google.android.gms.ads.nativead.NativeAd

class AdNativeType2 @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr) {

    private lateinit var binding: LayoutNativeType2Binding
    ...
    private fun initView() {
        binding = LayoutNativeType2Binding.inflate(LayoutInflater.from(context), this, true)
    }
