...
import com.example.myapplication.databinding.LayoutNativeType4Binding
import com.google.android.gms.ads.nativead.NativeAd

class AdNativeType4 @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr) {

    private lateinit var binding: LayoutNativeType4Binding
    ...
    private fun initView() {
        binding = LayoutNativeType4Binding.inflate(LayoutInflater.from(context), this, true)
    }
