package com.example.ads.natives.presentation.ui
...
import com.example.myapplication.databinding.LayoutNativeFullScreenBinding
import com.google.android.gms.ads.nativead.NativeAd

class AdNativeFullScreenView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr) {

    private lateinit var binding: LayoutNativeFullScreenBinding
    ...
    private fun initView() {
        binding = LayoutNativeFullScreenBinding.inflate(LayoutInflater.from(context), this, true)
    }
